...
//  each object representing a person with a name and 
// age property, write a function that returns 
// a new array containing the names of all people
...
//  categories, with the category names as keys and the arrays 
...
// ];
function groupedProduct(products) {
  const newProducts = {};
...
const products = [
  ...
  console.log(groupedProduct(products))
...
//  the names of all students whose average score is greater 
// than or equal to 85.
...
// Given an object representing a car, with properties
// for the make, model, year, and a method to display 
// the car's information, write a function that takes 
// the car object and adds a new method to the object
//  called age. The age method should return the current
//  age of the car based on the current year and the
//  car's year property.
// const car = {
//   make: 'Ford',
//   model: 'Ranger',
